...
export function renderTopLevelHelp(): string {
  return [
    ...
    "",
    "AGENT QUICKSTART: read skills/secret-shuttle/SKILL.md (the canonical operating manual)",
    "or paste the raw URL into your agent:",
    ...
    "",
    "Audit & history:",
    "  audit --since=<dur>|--batch=<id>            Owner-scoped audit summary (text or --json)",
    "",
    "Advanced:",
